...
const STEP_GUIDES: Record<string, { title: string; what: string; why: string; how: string[] }> = {
  admin: {
    ...
    how: ["نام مدرسه را وارد کنید", "نام و نام خانوادگی خود را به‌عنوان مدیر وارد کنید", "یک نام کاربری منحصر به فرد انتخاب کنید (مثلاً: admin)", "رمز عبور قوی با حداقل ۶ کاراکتر وارد کنید", "رمز عبور را دوباره تایید کنید", "روی دکمه «ادامه » کلیک کنید"],
  },
  grades: {
